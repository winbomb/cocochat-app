...
import 'package:cocochat_app/dao/init_dao/dm_info.dart';
import 'package:cocochat_app/dao/init_dao/group_info.dart';
import 'package:cocochat_app/dao/init_dao/user_info.dart';
import 'package:cocochat_app/event_bus_objects/private_channel_link_event.dart';
import 'package:cocochat_app/event_bus_objects/push_to_chat_event.dart';
...
import 'package:cocochat_app/services/task_queue.dart';
...
import 'package:cocochat_app/ui/chats/chats/chats_bar.dart';
import 'package:cocochat_app/ui/chats/chats/coco_chat_tile.dart';
...
class _ChatsPageState extends State<ChatsPage>
    ...
    if (Platform.isIOS) {
      ...
      return Slidable(
          ...
          endActionPane: ActionPane(
              ...
              motion: DrawerMotion(),
              children: children),
          child: CocoChatTile(tileData: data, onTap: onTap));
    } else {
  ...
  /// [CocoChatService] Message listener
  ///
      ...
      controller.prepare().then((value) {
        ...
        Navigator.push(
            ...
            MaterialPageRoute<String?>(
                builder: (context) => CocoChatPage.channel(
